...
data_z[,2:ncol(data)]<-as.data.frame(scale(data_z[, 2:ncol(data)]))
...
data_q[,1:ncol(data_q)]<-as.data.frame(scale(data_q[, 1:ncol(data_q)]))
...
data_task[,1:ncol(data_task)]<-as.data.frame(scale(data_task[, 1:ncol(data_task)]))
